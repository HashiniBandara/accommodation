            ...
            <div class="card mb-10 card-custom">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-lg-9">
                            <span class="switch switch-outline switch-icon switch-info">
                                <label>
                                    <input type="checkbox" name="accommodation_detail_status" id="accommodation_detail_status">
                                    <span></span>
                                </label>
                            </span>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select required name="accommodation_type_id" id="accommodation_type_id" class="form-control col-6">
                    ...
                    <x-single-file-chooser errors="{{ $errors->has($fieldName) ? $errors->first($fieldName) : '' }}"
                        placeholderText="Recommended Image Size : 500px x 500px"
                        filePath="{{ old($fieldName, getSettingValue($module_key, 'site_logo')) }}" :required="true"
                        uploadPath="settings" accept="image/*" acceptHint="jpg, jpeg, png" label="Site Logo"
                        fieldName="{{ $fieldName }}"></x-single-file-chooser>--}}

                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">Description</label>
                        <div class="col-sm-9">
                            <textarea autocomplete="off" required value="{{ old('description') }}" type="text"
                                row="3" name="description" id="description"
